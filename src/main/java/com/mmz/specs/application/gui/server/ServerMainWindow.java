...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        saveUserListButton = new JButton();
        saveUserListButton.setIcon(new ImageIcon(getClass().getResource("/img/gui/save.png")));
        saveUserListButton.setText("");
        saveUserListButton.setToolTipText("Сохранить изменения");
        toolBar2.add(saveUserListButton);
