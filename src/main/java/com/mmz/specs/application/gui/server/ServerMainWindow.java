...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void onSaveUserButton(UsersEntity usersEntity) {
        ...
        try {
            if ((currentLoggedInUser.getId() == usersEntity.getId()) && usersEntity.isAdmin() && usersEntity.isActive()) {
                updateUser(usersEntity, usersService, entity);
            ...
            JOptionPane.showMessageDialog(this,
                    ...
                    "Ошибка сохранения", JOptionPane.ERROR_MESSAGE);
            try {
                usersService.getUsersDao().getSession().getTransaction().rollback();
            } catch (Exception e1) {
    ...
    private void $$$setupUI$$$() {
        ...
        panel10.add(spacer11, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        ...
        adminUsersPanel.add(currentUserPanel, new GridConstraints(2, 1, 4, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
