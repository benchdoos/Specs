...
// DO NOT EDIT OR ADD ANY CODE HERE!
        ...
        scrollPane.addMouseWheelListener(new MouseAdapter() {
            ...
            public void mouseWheelMoved(MouseWheelEvent e) {
                ...
                if (controlDown) {
                    ...
                    //todo zoom image
                    updateImage(bufferedImage, bufferedImage.getWidth() / imageLabel.getIcon().getIconWidth() + ((float) e.getWheelRotation() * .50f));
                } else {
                    scrollPane.getVerticalScrollBar().setUnitIncrement(DEFAULT_UNIT_INCREMENT_SPEED);
                    scrollPane.getHorizontalScrollBar().setUnitIncrement(DEFAULT_UNIT_INCREMENT_SPEED);
                }
    ...
    private void updateImage(BufferedImage bufferedImage, float size) {
        ...
        BufferedImage resized = getBufferedImage(bufferedImage, resizedHeight, resizedWidth);
