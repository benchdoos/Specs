...
public class ClientConfigurationWindow extends JDialog {
    ...
    public ClientConfigurationWindow() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/img/gui/menu/connectionSettings128.png")));
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setLabelFor(serverAddressTextField);
        label2.setLabelFor(serverPortTextField);
    }
