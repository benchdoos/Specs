...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void onShowImage(BufferedImage image, String title) {
        ...
        imageFrame.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/img/gui/picture64.png")));
        ...
        imageFrame.setLocation(FrameUtils.getFrameOnCenter(this, imageFrame));
