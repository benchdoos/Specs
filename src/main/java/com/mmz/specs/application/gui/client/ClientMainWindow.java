...
public class ClientMainWindow extends JFrame {
    ...
    private void updateUserInterface() {
        if (ClientBackgroundService.getInstance().isConnected()) {
            ...
            updateInteractiveLabelsIcons(ConnectionStatus.CONNECTED);
            ...
            updateInteractiveLabelsIcons(ConnectionStatus.DISCONNECTED);
        }


    }

    private void updateInteractiveLabelsIcons(ConnectionStatus status) {
        switch (status) {
            case CONNECTED:
                viewSearchButton.setIcon(null);
                viewDetailListButton.setIcon(null);
                editDataButton.setIcon(null);
                break;
            default:
                ImageIcon icon = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/img/application/loading.gif")));
                viewSearchButton.setIcon(icon);
                viewDetailListButton.setIcon(icon);
                editDataButton.setIcon(icon);
                break;
        }
    }
    ...
    private void initConnectionLabels() {
        ...
        updateInteractiveLabelsIcons(ConnectionStatus.UNKNOWN);
    }
    ...
    private void onNoticeInfo() {
        ...
        if (lastSelectedPathComponent != null) {
            if (lastSelectedPathComponent.getUserObject() instanceof DetailEntity) {
                ...
                List<DetailListEntity> list = null; //not a bug, but feature
    ...
    private void updateDetailInfoPanelWithEntity(DetailEntity selectedComponent) {
        ...
        if (image != null) {
            ...
            detailIconLabel.addMouseListener(new MouseAdapter() {
                @Override
                public void mouseClicked(MouseEvent e) {
                    onShowImage(image, "Изображение " + selectedComponent.getNumber());
                }
            });
        } else {
            detailIconLabel.setIcon(null);
    ...
    private void onShowImage(BufferedImage image, String title) {
        final ImageViewer imageViewer = new ImageViewer(image);
        imageViewer.setPixelatedZoom(true);

        final JDialog dialog = new JDialog();
        dialog.setTitle(title);
        dialog.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/img/gui/picture64.png")));
        dialog.setModal(true);
        dialog.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

        dialog.add(imageViewer.getComponent());

        dialog.setSize(FrameUtils.DEFAULT_DIMENSION);
            ...
            public Component getTreeCellRendererComponent(JTree tree, Object value, boolean sel, boolean expanded, boolean leaf, int row, boolean hasFocus) {
                ...
                if (value instanceof DefaultMutableTreeNode) {
                    ...
                    if (node.getUserObject() instanceof DetailEntity) {
                        ...
                        //TODO change color for not active details...
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        viewDetailListButton.setIcon(new ImageIcon(getClass().getResource("/img/application/loading.gif")));
        ...
        viewSearchButton.setHorizontalTextPosition(2);
        viewSearchButton.setIcon(new ImageIcon(getClass().getResource("/img/application/loading.gif")));
        ...
        editDataButton.setIcon(new ImageIcon(getClass().getResource("/img/application/loading.gif")));
        ...
        panel1.add(button1, new GridConstraints(4, 1, 1, 1, GridConstraints.ANCHOR_EAST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        detailListPanel = new JPanel();
        detailListPanel.setLayout(new GridLayoutManager(11, 2, new Insets(0, 0, 0, 0), -1, -1));
        ...
        detailInfoPanel.setLayout(new GridLayoutManager(12, 6, new Insets(0, 0, 0, 0), -1, -1));
        ...
        detailInfoPanel.add(searchTextField, new GridConstraints(0, 1, 1, 4, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        numberLabel.setText("    ");
        detailInfoPanel.add(numberLabel, new GridConstraints(2, 1, 1, 4, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        titleLabel = new JLabel();
        titleLabel.setText("    ");
        detailInfoPanel.add(titleLabel, new GridConstraints(3, 1, 1, 4, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        unitLabel = new JLabel();
        unitLabel.setText("    ");
        detailInfoPanel.add(unitLabel, new GridConstraints(4, 1, 1, 4, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        finishedWeightLabel = new JLabel();
        finishedWeightLabel.setText("    ");
        detailInfoPanel.add(finishedWeightLabel, new GridConstraints(5, 1, 1, 4, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        workpieceWeightLabel = new JLabel();
        workpieceWeightLabel.setText("    ");
        detailInfoPanel.add(workpieceWeightLabel, new GridConstraints(6, 1, 1, 4, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        techProcessLabel = new JLabel();
        techProcessLabel.setText("     ");
        detailInfoPanel.add(techProcessLabel, new GridConstraints(7, 1, 1, 4, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        isActiveLabel = new JLabel();
        isActiveLabel.setText("   ");
        detailInfoPanel.add(isActiveLabel, new GridConstraints(8, 1, 1, 4, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        detailIconLabel.setText("Нет изображения");
        detailInfoPanel.add(detailIconLabel, new GridConstraints(1, 0, 1, 5, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, new Dimension(128, 128), new Dimension(128, 128), new Dimension(128, 128), 0, false));
        final JLabel label9 = new JLabel();
        label9.setText("Последнее извещение:");
        detailInfoPanel.add(label9, new GridConstraints(9, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        detailInfoPanel.add(noticeInfoButton, new GridConstraints(9, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final Spacer spacer4 = new Spacer();
        detailInfoPanel.add(spacer4, new GridConstraints(10, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL, 1, GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        editButton = new JButton();
        editButton.setEnabled(false);
        editButton.setText("Редактировать");
        editButton.setMnemonic('Р');
        editButton.setDisplayedMnemonicIndex(0);
        detailInfoPanel.add(editButton, new GridConstraints(11, 3, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final Spacer spacer5 = new Spacer();
        detailInfoPanel.add(spacer5, new GridConstraints(2, 5, 10, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL, 1, GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
