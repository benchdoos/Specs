...
//            setTabsEnabled(false);
    ...
    private void unlockTables(boolean unlock) {
        for (int i = 0; i < clientMainTabbedPane.getTabCount(); i++) {
            ...
            try {
                ...
                if (policyManager.isAvailableForAdminOnly() && policyManager.isAvailableForConnectionOnly()) {
                    setEnabledTab(i, isAdmin && isConnected);
                }
                if (policyManager.isAvailableForAdminOnly() && !policyManager.isAvailableForConnectionOnly()) {
                    setEnabledTab(i, isAdmin);
                }
