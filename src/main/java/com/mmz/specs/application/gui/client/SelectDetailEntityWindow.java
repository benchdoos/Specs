            ...
            if (entities != null) {
                if (entities.size() == 1) {
                    ...
                    if (entity != null) {
                        DetailService service = new DetailServiceImpl(session);
                        try {
                            final DetailEntity detailById = service.getDetailById(entity.getId());
                            //todo add check if titles are equal
                        } catch (Exception e) {
                ...
                if (detailById == null) {
                    ...
                    entities.add(service.getDetailById(service.addDetail(entity)));
                }
            }*/
            dispose();
