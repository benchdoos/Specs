...
public class CommonSettingsManager {
    ...
    public static String getServerSettingsFilePath() throws IOException {
        ...
        try (final FileInputStream in = new FileInputStream(ApplicationConstants.SETTINGS_FILE_PATH)) {
    ...
    public static void setServerSettingsFilePath(String path) throws IOException {
        ...
        try (final FileOutputStream os = new FileOutputStream(ApplicationConstants.SETTINGS_FILE_PATH)) {
            properties.storeToXML(os, ApplicationConstants.INTERNAL_FULL_NAME + " settings file locations",
